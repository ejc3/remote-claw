...
// selector (it always fell back to the ollama default, so it could never exercise Bedrock and CI
// couldn't catch the regression because CI has no opencode server and skips the suite entirely).
