...
| A1.8a1-E1b2 | Implement exact workspace evidence | Planned next; v1 rejects symlinks in every selector/allowed-root component and must close canonical-directory, filesystem-identity, allowed-root-ancestry, mount-namespace, and workspace-parent bytes |
