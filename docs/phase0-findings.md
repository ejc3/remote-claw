...
lower-fidelity tmux route. M1 structured native-RC text coexistence and local Graduate acceptance are
now implemented; literal official Claude UI and exact-SHA deployed acceptance remain open. It is one
part of the broader Claude/Codex/OpenCode/tmux product.
