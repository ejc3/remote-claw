...
> now uses the client REST/SSE seam summarized in [Phase 0 findings](phase0-findings.md). Local Graduate
> acceptance is green; literal official Claude UI and exact-SHA deployed acceptance remain open.
