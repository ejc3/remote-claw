...
/**
 * remote-claw theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { remoteClawTheme } from './remote-claw';
 *   import './remote-claw.css';
 */
export const remoteClawTheme = {
  name: 'remote-claw',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "\"Inter Variable\", Inter, ui-sans-serif, system-ui, -apple-system, \"Segoe UI\", Roboto, sans-serif",
    "--font-family-heading": "\"Inter Variable\", Inter, ui-sans-serif, system-ui, -apple-system, \"Segoe UI\", Roboto, sans-serif",
    "--font-family-code": "ui-monospace, \"SF Mono\", Menlo, monospace",
    ...
    "--color-background-surface": "light-dark(#ffffff, #141417)",
    "--color-background-body": "light-dark(#f4f5f8, #0a0a0b)",
    "--color-background-card": "light-dark(#ffffff, #141417)",
    "--color-background-popover": "light-dark(#ffffff, #1b1b1f)",
    "--color-background-muted": "light-dark(#05365910, #1b1b1f)",
    ...
    "--color-text-primary": "light-dark(#0a1317, #ececee)",
    "--color-text-secondary": "light-dark(#4e606f, #9a9aa3)",
    "--color-text-disabled": "light-dark(#a4b0bc, #6f747c)",
    "--color-text-accent": "light-dark(#4b4ee0, #7c7ef5)",
    ...
    "--color-icon-accent": "light-dark(#4b4ee0, #7c7ef5)",
    "--color-icon-primary": "light-dark(#1C1B21, #E3E1EB)",
    "--color-icon-secondary": "light-dark(#484551, #ADA9B8)",
    "--color-icon-disabled": "light-dark(#928F9D, #605D6A)",
    "--color-success": "light-dark(#0d8626, #34d399)",
    "--color-error": "light-dark(#e3193b, #fb7185)",
    "--color-warning": "light-dark(#b07d05, #fbbf24)",
    ...
    "--color-border": "light-dark(#05365919, #26262b)",
    "--color-border-emphasized": "light-dark(#ccd3db, #3a3a42)",
    "--color-skeleton": "light-dark(#ADA9B8, #484551)",
    ...
    "--color-track": "light-dark(#ADA9B8, #484551)"
  },
